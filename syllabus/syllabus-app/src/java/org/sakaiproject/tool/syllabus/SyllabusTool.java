/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/syllabus/branches/sakai-2.9.x/syllabus-app/src/java/org/sakaiproject/tool/syllabus/SyllabusTool.java $
...
public class SyllabusTool
{
  ...
  public class DecoratedSyllabusEntry
  {
    ...
    public String processListUseTemplateForTemplate() throws PermissionException
    {
      templateAssetHolder = this.getEntry().getAsset();
      entries.clear();
      return processListNewTemplate();
    }

    public String processListUseTemplate() throws PermissionException
    {
      templateAssetHolder = this.getEntry().getAsset();
      entries.clear();
  ...
  protected String templateAssetHolder = null;
...
//for test        entry.getEntry().getAsset(), null, null, null);
  ...
  *************************/
  ...
  public String processTemplate() throws PermissionException
  {
    ...
    {
      logger.info(this + ".processTemplate in SyllabusTool: " + e);
      FacesContext.getCurrentInstance().addMessage(
          null,
          MessageFactory.getMessage(FacesContext.getCurrentInstance(),
              "error_general", (new Object[] { e.toString() })));
  ...
  public String processTemplateUsingTemplate() throws PermissionException
  {
    try
    {
      if (!this.checkAccess())
      ...
      { 
        return "template_select_template";
      }
    }
    catch (Exception e)
    {
      logger.info(this + ".processTemplateUsingTemplate in SyllabusTool: " + e);
      FacesContext.getCurrentInstance().addMessage(
          null,
          MessageFactory.getMessage(FacesContext.getCurrentInstance(),
              "error_general", (new Object[] { e.toString() })));
  ...
  public String processEditTemplateCancel()
  {
    try
    {
      if (entry != null)
    ...
    {
      logger.error(this + ".processEditTemplateCancel - " + e);
      e.printStackTrace();
    }
    displayTitleErroMsg = false;
    displayEvilTagMsg=false;
  ...
  public String processEditTemplatePost() throws PermissionException
  {
    try
    { 
      displayTitleErroMsg = false;
    ...
    {
      logger.info(this + ".processEditTemplatePost in SyllabusTool: " + e);
      e.printStackTrace();
      FacesContext.getCurrentInstance().addMessage(
          null,
          MessageFactory.getMessage(FacesContext.getCurrentInstance(),
  ...
  public String processCreateAndEditTemplate()
  {
    ...
    {
      logger.info(this + ".processCreateAndEditTemplate() in SyllabusTool: " + e);
      FacesContext.getCurrentInstance().addMessage(
          null,
          MessageFactory.getMessage(FacesContext.getCurrentInstance(),
              "error_general", (new Object[] { e.toString() })));
...
//          }
  ...
  public String getTemplateAssetHolder()
  {
    if (templateAssetHolder == null){
      return "";
    } 
    else 
    {
  ...
  public void setTemplateAssetHolder(String tempAsset)
  {
    this.templateAssetHolder = tempAsset;
  }
