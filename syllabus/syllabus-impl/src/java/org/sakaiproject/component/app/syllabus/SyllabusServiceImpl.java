/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/syllabus/branches/sakai-2.9.x/syllabus-impl/src/java/org/sakaiproject/component/app/syllabus/SyllabusServiceImpl.java $
...
/*decode
                                ...
                                syData = syllabusManager
                                    .createSyllabusDataObject(
                                        ...
                                        syData.getEmailNotification(), "f");  // TODO: BOOKMARKED
            ...
            if (fromSyDataSet != null && fromSyDataSet.size() > 0)
            {
                ...
                while (fromSetIter.hasNext())
                {
                  ...
                  SyllabusData newToSyData = syllabusManager
                          ...
                          toSyData.getStatus(), toSyData.getEmailNotification(), "f"); // TODO: BOOKMARKED
						...
						SyllabusData newToSyData = syllabusManager
								.createSyllabusDataObject(toSyData.getTitle(),
										...
										toSyData.getView(), toSyData
												.getStatus(), toSyData
												.getEmailNotification(), "f"); // TODO: BOOKMARKED
