/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/syllabus/branches/sakai-2.9.x/syllabus-api/src/java/org/sakaiproject/api/app/syllabus/SyllabusManager.java $
...
public interface SyllabusManager
{
  ...
  public SyllabusData createSyllabusDataObject(String title, Integer position,
      String assetId, String view, String status, String emailNotification, String isTemplate);
